...
<div class="container">
    ...
    while ($row = $experiences->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<p>Description: " . $row['description'] . "</p>";
        echo "<button onclick='editExperience(" . $row['ID'] . ")'>Modifier</button>";
        echo "<button onclick='deleteExperience(" . $row['ID'] . ")'>Supprimer</button>";
        echo "</div>";
    }
    ?>
</div>
<div class="container">
    ...
    while ($row = $hobbies->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<button onclick='editHobby(" . $row['ID'] . ")'>Modifier</button>";
        echo "<button onclick='deleteHobby(" . $row['ID'] . ")'>Supprimer</button>";
        echo "</div>";
    }
    ?>
</div>
